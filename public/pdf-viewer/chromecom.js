...
function getEmbedderOrigin(callback) {
    const origin =
        window === top ? location.origin : location.ancestorOrigins[0]
    if (origin === 'null') {
        ...
        document.getElementById('chrome-file-fallback').onchange = function () {
            ...
            if (file) {
                ...
                if (originalFilename !== file.name) {
                    ...
                    originalUrl =
                        'file:///fakepath/to/' + encodeURIComponent(file.name)
                }
            ...
            if (chrome.storage.managed) {
                ...
                chrome.storage.managed.get(
                    ...
                    function (items) {
                        ...
                        if (
                            items.enableHandToolOnLoad &&
                            !items.cursorToolOnLoad
                        ) {
                        ...
                        if (
                            items.textLayerMode !== 1 &&
                            items.disableTextLayer
                        ) {
